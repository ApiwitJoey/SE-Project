...
const sendEmail = async (option) => {
  ...
  const message = {
    ...
    html:
    `<h1> Hi ${option.toUser} \nOTP : ${option.OTP}</h1>
    <div style="max-width:700px;margin:40px auto;padding:40px 30px;background:#fff;border-radius:10px;font-family:Arial,sans-serif">
        <div style="text-align:center;margin-bottom:30px">
          <img src="https://drive.google.com/file/d/1Gxi-c0wC3wGCEy9lwomGbu4y2glQmd7G/view?usp=sharing" alt="SABAAI Logo" style="max-width:200px;">
        </div>
        <h2 style="text-align:center;font-size:22px;margin-bottom:30px;">
            Hi ${option.toUser}
        </h2>
        <p style="font-size:16px;line-height:1.6;color:#555;">Hi joyye,</p>
        <p style="font-size:16px;line-height:1.6;color:#555;">
          your otp ${option.OTP}
          You have activated 2-Step Verification for your  account. For some actions like logging in,
          you will need to enter a 6-digit security code that sends to you via email.
        </p>
        <p style="font-size:16px;line-height:1.6;color:#555;">Roblox</p>
        <div style="font-size:13px;color:#999;margin-top:40px;text-align:left;">
          This message was generated by <a href="https://www.instagram.com/apw_joeee/?utm_source=ig_web_button_share_sheet" style="color:#999;">joyye.com</a>.
        </div>
      </div>` 
  };
